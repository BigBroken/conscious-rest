...
export const mattresses: Mattress[] = [
  ...
  },
  {
    ...
    atVerdict: "The W2.15 Hybrid is the Wright model we recommend — the coil base provides the responsiveness and freedom of movement that AT principles call for. Skip the W1.27 all-foam model; memory foam works against body awareness. The hybrid strikes a practical balance for people who want quality American craftsmanship without fully committing to a firm latex surface.",
    prosAT: [
    ...
    constructiveRestScore: "Moderate — the foam comfort layers soften the feedback too much for ideal semi-supine practice; use the floor for constructive rest",
  },
  {
    ...
    constructiveRestScore: "Excellent — arrange the firmest layer on top for semi-supine practice, or use all three layers in their firmest configuration",
  },
  {
    slug: "airweave",
    ...
    constructiveRestScore: "Excellent — the firm Airfiber surface provides clear, consistent feedback similar to a padded floor",
  },
  {
    ...
    atVerdict: "Sleep EZ lets you choose the firmness of each individual latex layer — Soft, Medium, Firm, or Extra Firm. For AT purposes, we recommend all-Firm or a Firm/Extra Firm combination. The ability to swap layers after purchase means your mattress can evolve as your body awareness develops.",
    prosAT: [
    ...
    constructiveRestScore: "Excellent — configure all layers to Firm or Extra Firm for semi-supine practice",
  },
  {
    slug: "diy-mattress",
    ...
    atVerdict: "The ultimate AT mattress concept. You buy the components — latex layers, cover, foundation — and assemble them yourself. There is zero interference because there is no manufacturer deciding what your body needs. You decide everything. This is the Alexander Technique principle of self-awareness applied directly to mattress selection.",
    prosAT: [
    ...
    constructiveRestScore: "Outstanding — build it as firm as you want; you can create a surface as close to floor-quality feedback as you choose",
  },
];
